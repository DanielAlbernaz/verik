    ...
    <div class="container-fluid">
        <div class="main__footer d-flex justify-content-between">
            <div class="footer__widget footer__widget--width">
                <h2 class="footer__widget--title text-ofwhite h3">Ditec agora é Verik
                ...
                <div class="footer__widget--inner">
                    <p class="footer__widget--desc text-ofwhite mb-20">Evoluir sempre fez parte da nossa história.<br />
                        Suporte total para o seu projeto.</p>
                    <p class="footer__widget--desc text-ofwhite mb-20">
                        AV Rio Verde, Setor Pedro Ludovico <br /> Goiânia - GO | CEP: 74.835-270<br />
                        <a href="tel:556232803350">(62) 3280-3350</a><br />
                        <a
                            href="maito:gerentecomercial@ditecdistribuidora.com.br">gerentecomercial@ditecdistribuidora.com.br</a>
                    </p>
                    <div class="footer__social">
                        <h3 class="social__title text-ofwhite h4 mb-15">Siga-nos</h3>
            ...
            <div class="footer__widget--menu__wrapper d-flex footer__widget--width">
                <div class="footer__widget">
                    <h2 class="footer__widget--title text-ofwhite h3">Intitucional
                        <button class="footer__widget--button" aria-label="footer widget button">
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                                width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z"
                ...
                <div class="footer__widget">
                    <h2 class="footer__widget--title text-ofwhite h3">Minha conta
                        <button class="footer__widget--button" aria-label="footer widget button">
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                                width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z"
            ...
            <div class="footer__widget footer__widget--width">
                <h2 class="footer__widget--title text-ofwhite h3">Central de ajuda
                    <button class="footer__widget--button" aria-label="footer widget button">
                        <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                            width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                            <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z"
            ...
            <div class="footer__widget footer__widget--width">
                ...
                <div class="footer__widget--inner">
                    <p class="footer__widget--desc text-ofwhite m-0">Cadastre-se na nossa newsletter e receba
                        informações<br /> sobre produtos, novidades, dicas e muito mais.</p>
                    <div class="newsletter__subscribe">
                        <form class="newsletter__subscribe--form" action="#">
                            <label>
                                <input class="newsletter__subscribe--input" placeholder="Seu e-mail" type="email">
                            </label>
                            <button class="newsletter__subscribe--button" type="submit">ENVIAR</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="footer__bottom d-flex justify-content-between align-items-center">
            <p class="copyright__content text-ofwhite m-0">Copyright © 2022 <a class="copyright__content--link"
                    href="index.html">Verik</a> . Todos os direitos reservados.</p>
            <div class="footer__payment text-right">
                <!-- <img class="display-block" src="assets/img/other/play-ios.png" alt="visa-card"> -->
            </div>
        </div>
    </div>
</footer>