                    ...
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            ...
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                ...
                                <li class="breadcrumb__content--menu__items"><a class="text-white" href="<?= $path["site"] ?>dicas-novidades">Dicas e novidades</a></li>                                
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="blog__details--wrapper">
                            ...
                            <div class="blog__tags--social__media d-flex align-items-center justify-content-between">                                
                                <div class="blog__social--media d-flex align-items-center">
                                    <label class="blog__social--media__title">Compartilhe :</label>
                                    <ul class="d-flex">
