...
$acaodoformulario = 'index.php?acao=cadastrar&ctrl=treinamento';
...
//Cria status
// $optionsAbaTreinamento[] = '<option value="Treinamento Ao Vivo" >Treinamento Ao Vivo</option>';
// $optionsAbaTreinamento[] = '<option value="Treinamento Gravado" selected="selected">Treinamento Gravado</option>';
// $optionsAbaTreinamento[] = '<option value="Treinamento Presencial">Treinamento Presencial</option>';

// $objForm->sk_formSelect('Tipo Treinamento', 'tipo_treinamento', $optionsAbaTreinamento, true, 'Selecione uma opção');
...
$objForm->sk_formTextUrl('Link treinamento','url','',false,'Aqui você adiciona o link do treinamento.');
...
$objForm->sk_formText('Instrutor','instrutor','',false,'Aqui você um instrutor.');
