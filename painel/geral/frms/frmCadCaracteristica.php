...
$nomedoformulario = 'Cadastrar Caracteristica';
$acaodoformulario = 'index.php?acao=cadastrar&ctrl=caracteristica';
$avisodoformulario = 'Esta página você cadastra as caracteristicas.';
...
$objForm->sk_formFileCrop("Imagem principal",'imagem',true, 'Resolução sugerida - 40px X 40px');
