...
$nomedoformulario = 'Cadastrar Vantagem';
$acaodoformulario = 'index.php?acao=cadastrar&ctrl=vantagem';
$avisodoformulario = 'Esta página você cadastra os vantagem.';
...
$objForm->sk_formFileCrop("Imagem",'imagem',true,'Tamanho 50px x 50px');
