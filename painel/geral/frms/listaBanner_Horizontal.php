...
$objForm->sk_formListar('Banners',$dadosDaTabela,$banners,$campos,'banner_horizontal',$publicar,$alterar,$excluir);

?>
 
 <div>

<a href="index.php?acao=frmCad&ctrl=banner_horizontal" title="" class="button greenB" style="margin: 40px 5px 5px 0px; float: right;"><span>Cadastrar novo</span></a>
