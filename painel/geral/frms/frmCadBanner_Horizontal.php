...
$acaodoformulario = 'index.php?acao=cadastrar&ctrl=banner_horizontal';
...
$objForm->sk_formFileCrop("Imagem",'imagem',true,'Tamanho 1200px x 276px');

$objForm->sk_formText('Link de redirecionamento','url','',false,'Link de redirecionamento para o botão.');
