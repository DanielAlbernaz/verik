...
$nomedoformulario = 'Alterar Informações de política de Trocas e Devoluções';
$acaodoformulario = 'index.php?acao=alterar&ctrl=trocasdevolucoes';
$avisodoformulario = 'Esta página você altera as Informações de política de trocasdevolucoes';
...
$objForm->sk_formText('Título','titulo','',true,'Aqui digita um título.', $trocasdevolucoesForm->titulo);
...
//Cria um input hidden
$objForm->sk_formHidden('imgAntiga',$trocasdevolucoesForm->imagem);
