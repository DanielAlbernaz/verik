...
for($i=0;$i<$blogs["num"];$i++){
    ...
    if($blogs[$i]->data_expiracao != '0000-00-00 00:00:00'){
...
$objForm->sk_formListar('Empreendimento',$dadosDaTabela,$empreendimento,$campos,'empreendimento',$publicar,$alterar,$excluir);
