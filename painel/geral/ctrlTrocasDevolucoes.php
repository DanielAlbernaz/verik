...
$permissao = $objSecao->permissaoSecaoFixaUsuario("19",$objSession2->get('tlAdmLoginId'));
...
case "alterar":
	...
	if($objPost->param["imagem"]["name"] !=""){
		...
		$dir = "arq_trocasdevolucoes/";
		if(!file_exists("arq_trocasdevolucoes")) {
				$objUteis->criaDir("arq_trocasdevolucoes");
		}
		$nomeImg = "trocasdevolucoes".time().".".$formatoImgDestaque;
		$temp = $dir.$nomeImg;
