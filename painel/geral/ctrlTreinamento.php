...
case "cadastrar":
	...
	$result = $objTreinamento->cadastrar($form);
	...
	$objUteis
			->showResult("Cadastrado com sucesso.",
					...
					"mostraMensagem",
					'index.php?acao=listar&ctrl=treinamento');
	exit();
	break;
case "listar":
	// lista todos os dados do banco de dados
	$condicao = array();
	$treinamentos = $objTreinamento->listar();
	$objUteis->encode($treinamentos);
	// inclui o formulario
	$abrePag = "../frms/listaTreinamento.php";
	break;
case "frmAlterar":
	...
	$treinamentoForm = $objTreinamento->lista($condicao);
	$objUteis->encode($treinamentoForm);
	// inclui o formulario
	$abrePag = "../frms/frmAltTreinamento.php";
	break;
case "alterar":
	...
	$objUteis->decode($form);
	$result = $objTreinamento->alterar($form);
...
case "deletar":
	...
	$result = $objTreinamento->deletar($objPost->param['id']);
...
case "publicar":
	//publica o objeto
	$result = $objTreinamento->publicar($objPost->param['id'], $objPost->param['status']);
