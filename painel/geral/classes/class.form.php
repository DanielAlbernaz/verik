...
class Form {
	...
	public function sk_fimDoFormularioSkWizard() {
		$formulario = "";
		$formulario .= '</div>';
		$formulario .= '</form>';
		$formulario .= '</div>';
	...
	public function sk_formData($nomeLabel = '', $nameInput = '', $required = false, $descripton = '', $value = '', $readOnly = null) {
		if ($required == true) {
			$required = 'validate[required]';
		...
		$input .= '<input type="text" style="width:190px;" name="' . $nameInput . '" id="' . $nameInput . '" class="' . $required . ' ' . $tooltip . ' maskDate" title="' . $textoDescription . '" value="' . $value . '"  '. $readOnly .' />';
		$input .= '</div><div class="clear"></div>';
		$input .= '</div>';
		
		echo $input;
	}
	public function sk_formDataHoras($nomeLabel = '', $nameInput = '', $required = false, $descripton = '', $value = '', $readOnly = '') {
		$addAsteristico = '';
                if ($required == true) {
			$required = 'validate[required]';
			$addAsteristico = '<span class="req">*</span>';
		...
		$input .= '<label>' . $addAsteristico . " " . $nomeLabel . '</label>';
		$input .= '<div class="formRight">';
		$input .= '<input type="text" style="width:190px;" name="' . $nameInput . '" id="' . $nameInput . '" class="' . $required . ' ' . $tooltip . ' maskDateTime" title="' . $textoDescription . '" value="' . $value . '" '. $readOnly .'/>';
		$input .= '</div><div class="clear"></div>';
		$input .= '</div>';
	...
	public function sk_formText($nomeLabel = '', $nameInput = '', $maxlength = '255', $required = false, $descripton = '', $value = '', $readonly = '') {
		if ($required == true) {
			$required = 'validate[required]';
			$addAsteristico = '<span class="req">*</span>';
		}
		...
		$input .= '<label>' . $addAsteristico . " " . $nomeLabel . '</label>';
		$input .= '<div class="formRight">';
		$input .= '<input type="text" name="' . $nameInput . '" id="' . $nameInput . '" maxlength="' . $maxlength . '" class="' . $required . ' ' . $tooltip . '" title="' . $textoDescription . '" value="' . $value . '" '. ($readonly ? $readonly : '') .' />';
		$input .= '</div><div class="clear"></div>';
		$input .= '</div>';
	...
	public function sk_formTextPequeno($nomeLabel = '', $nameInput = '', $maxlength = '255', $required = false, $descripton = '', $value = '', $readOnly = null) {
		if ($required == true) {
			$required = 'validate[required]';
			$addAsteristico = '<span class="req">*</span>';
		}
		...
		$input .= '<label>' . $addAsteristico . " " . $nomeLabel . '</label>';
		$input .= '<div class="formRight">';
		$input .= '<input type="text" style="width: 100px;" name="' . $nameInput . '" id="' . $nameInput . '" maxlength="' . $maxlength . '" class="' . $required . ' ' . $tooltip . '" title="' . $textoDescription . '" value="' . $value . '"  '. $readOnly .'/>';
		$input .= '</div><div class="clear"></div>';
		$input .= '</div>';
	...
	public function sk_formTextTelefonePequeno($nomeLabel = '', $nameInput = '', $maxlength = '255', $required = false, $descripton = '', $value = '') {
		if ($required == true) {
			$required = 'validate[required] maskPhone';
			$addAsteristico = '<span class="req">*</span>';
		} else {
		...
		$input .= '<label>' . $addAsteristico . " " . $nomeLabel . '</label>';
		$input .= '<div class="formRight">';
		$input .= '<input style="width:100px;" type="text" name="' . $nameInput . '" id="' . $nameInput . '" maxlength="' . $maxlength . '" class="' . $required . ' ' . $tooltip . '" title="' . $textoDescription . '" value="' . $value . '" />';
		$input .= '</div><div class="clear"></div>';
		$input .= '</div>';
	...
	public function sk_formSelect($nomeLabel = '', $nameInput = '', $arrayOption = '', $required = false, $descripton = '', $multiple = false) {
		...
		$input .= '<label>' . $addAsteristico . " " . $nomeLabel . '</label>';
		$input .= '<div class="formRight">';
		$input .= '<select ' . $multiplo . ' style="' . $multipleStyle . '" name="' . $nameInput . '" id="' . $nameInput . ' appearance-select" class="' . $required . ' ' . $tooltip . ' ' . $classeMultipe . '" title="' . $textoDescription . '">';
	...
	public function sk_formSelectMaior($nomeLabel = '', $nameInput = '', $arrayOption = '', $required = false, $descripton = '', $multiple = false) {
		$multiplo = '';
		$classeMultipe = '';
		$selecione = '';
		if ($required == true) {
		...
		$input .= '<div class="formRow">';
		$input .= '<label>' . $addAsteristico . " " . $nomeLabel . '</label>';
		$input .= '<div class="formRight novo">';
	...
	public function sk_formListarCurriculos($nome = '', $arrayTableNome, $arrayDadosTable, $campos, $ctrl = '', $permissaopublicar = 0, $permissaoalterar = 0, $permissaoexcluir = 0, $aviso = '', $acaoOrdenar = '',$ctrlRetorno = '',$titulo = '') {
		$formulario = "";
		if ($acaoOrdenar) {
			$formulario .= '<script>';
			$formulario .= '$(function(){';
...
<div class="wrapper">
	...
	<div class="widget">
		...
		if ($permissaopublicar === 1) {
			$formulario .= '<th>STATUS</th>';
                ...
                if ($permissaoalterar === 1) {
                    if($titulo == ''){
                        $formulario .= '<th>EDITAR</th>';
                    }else{
                        $formulario .= '<th>'.$titulo.'</th>';
                    }
                }
                if ($permissaoexcluir === 1) {
                $formulario .= '<th>EXCLUIR</th>';
                }
		$formulario .= '
				</tr>
				';
		...
		for($i = 0; $i < $arrayDadosTable ["num"]; $i ++) {
			...
			for($j = 0; $j < count($arrayTableNome); $j ++) {
				...
				$formulario .= $arrayDadosTable[$i]->$campo;
				$formulario .= '</td>';
			}
			...
			if ($permissaopublicar === 1) {
				...
				if ($permissaopublicar === 1) {
					$formulario .= '<a href="javascript:;" title="' . $tooltip . '" class="tipS" onclick="confirmPubGeral(\'index.php?acao=publicar&ctrl=' . $ctrl . '&id=' . $arrayDadosTable [$i] ->id . '&status=' . $statusAlterar . '\','. ($ctrlRetorno  ? $ctrlRetorno :'\'index.php?acao=listar&ctrl=' . $ctrl . '\'' ). ');">';
				...
				$formulario .= '</td>';
                        ...
                        if ($permissaoalterar === 1) {
                            ...
                            if ($permissaoalterar === 1) {
                                    $formulario .= '<a href="index.php?acao=frmAlterar&ctrl=' . $ctrl . '&id=' . $arrayDadosTable [$i]->id . '" title="'.($titulo == '' ? 'Editar' : 'Visualizar').'" class="tipS">';
                                    if($titulo == ''){
                                        $formulario .= '<img src="images/icons/control/16/pencil.png" alt="" />';
                                    }else{
                                        $formulario .= '<img src="images/icons/control/16/search.png" alt="" />';
                                    }
                                    $formulario .= '</a>';
                            }
                            $formulario .= '</td>';
                        ...
                        if ($permissaoexcluir === 1) {
                            $formulario .= '<td class="actBtns">';
                            if ($permissaoexcluir === 1) {
                                    $formulario .= '<a href="javascript:;" title="Excluir" onclick="confirmarExcluirIndividual(' . $arrayDadosTable [$i]->id .')" class="tipS">';
	...
	public function sk_formFileCrop($nomeLabel = '', $nameInput = '', $required = false, $descripton = '', $arquivoImg = '',$arquivoPdf = '', $urlExcluir = '', $urlRetorno = '') {
		...
		if ($arquivoImg) {
			...
			if ($urlExcluir && $urlRetorno) {
				...
				$input .= '<a class="tipS" title="Excluir imagem principal" href="javascript:;" onclick="confirmDelGeralfile(\'' . $urlExcluir . '\',\'' . $urlRetorno . '\')"> <img src="images/icons/control/16/cancel.png"/> </a>';

				$input .= '</div>';

			}

			$input .= '<a href="' . ($arquivoPdf ? $arquivoPdf : $arquivoImg) . '" title="" rel="lightbox"><img src="' . ($arquivoPdf ? $arquivoPdf : $arquivoImg) . '" height="100" alt="" /></a>';
		...
		$input .= '<input type="file" name="' . $nameInput . '" id="' . $nameInput . '" class="' . $required . ' ' . $tooltip . '" title="' . $textoDescription . '"  onchange="preview(this);"/>';

		$input .= '</div><div class="clear"></div>';

		$input .= '</div>';

                //campo para exibir a imagem que será recortada

                $input .= '<div class="formRow imgPreview" style="text-align:center; margin-left: 65px; display:none;">';

                $input .= '<p><i>Selecione onde a imagem será recortada.</i></p>';

                $input .= '<div class="clear"></div>';

                $input .= '<div class="formLeft">';

                $input .= '<img id="jcrop" style="background-color:transparent"/>';

                $input .= '</div>';

                $input .= '</div>';

                //campos para receber as coordenadas de recorte.

                $input .= '<div id="debug">';

                $input .= '<input type="hidden" id="x"  size="5"  name="x"/>';

                $input .= '<input type="hidden" id="x2" size="5"  name="x2"/>';

                $input .= '<input type="hidden" id="y"  size="5"  name="y"/>';

                $input .= '<input type="hidden" id="y2" size="5"  name="y2"/>';

                $input .= '<input type="hidden" id="h"  size="5"  name="h"/>';

                $input .= '<input type="hidden" id="w"   size="5" name="w"/>';
	...
	public function sk_formFileCrop2($nomeLabel = '', $nameInput = '', $required = false, $descripton = '', $arquivoImg = '',$arquivoPdf = '', $urlExcluir = '', $urlRetorno = '') {
		...
		$input .= '<input type="file" name="' . $nameInput . '" id="' . $nameInput . '" class="' . $required . ' ' . $tooltip . '" title="' . $textoDescription . '"  onchange="preview2(this);"/>';
		...
		$input .= '</div>';
                ...
                $input .= '<div class="formRow imgPreview2" style="text-align:center; margin-left: 65px; display:none;">';
                ...
                $input .= '<img id="jcrop2" style="background-color:transparent"/>';
                ...
                $input .= '<input type="hidden" id="_x"  size="5"  name="_x"/>';

                $input .= '<input type="hidden" id="_x2" size="5"  name="_x2"/>';

                $input .= '<input type="hidden" id="_y"  size="5"  name="_y"/>';

                $input .= '<input type="hidden" id="_y2" size="5"  name="_y2"/>';

                $input .= '<input type="hidden" id="_h"  size="5"  name="_h"/>';

                $input .= '<input type="hidden" id="_w"   size="5" name="_w"/>';
	...
	public function sk_formFileCrop3($nomeLabel = '', $nameInput = '', $required = false, $descripton = '', $arquivoImg = '',$arquivoPdf = '', $urlExcluir = '', $urlRetorno = '') {
		...
		$input .= '<input type="file" name="' . $nameInput . '" id="' . $nameInput . '" class="' . $required . ' ' . $tooltip . '" title="' . $textoDescription . '"  onchange="preview3(this);"/>';
		...
		$input .= '</div>';
                ...
                $input .= '<div class="formRow imgPreview3" style="text-align:center; margin-left: 65px; display:none;">';
                ...
                $input .= '<img id="jcrop3" style="background-color:transparent"/>';
                ...
                $input .= '<input type="hidden" id="__x"  size="5"  name="__x"/>';

                $input .= '<input type="hidden" id="__x2" size="5"  name="__x2"/>';

                $input .= '<input type="hidden" id="__y"  size="5"  name="__y"/>';

                $input .= '<input type="hidden" id="__y2" size="5"  name="__y2"/>';

                $input .= '<input type="hidden" id="__h"  size="5"  name="__h"/>';

                $input .= '<input type="hidden" id="__w"   size="5" name="__w"/>';
	...
	public function sk_formFileCrop4($nomeLabel = '', $nameInput = '', $required = false, $descripton = '', $arquivoImg = '',$arquivoPdf = '', $urlExcluir = '', $urlRetorno = '') {
		...
		$input .= '<input type="file" name="' . $nameInput . '" id="' . $nameInput . '" class="' . $required . ' ' . $tooltip . '" title="' . $textoDescription . '"  onchange="preview4(this);"/>';
		...
		$input .= '</div>';
                ...
                $input .= '<div class="formRow imgPreview4" style="text-align:center; margin-left: 65px; display:none;">';
                ...
                $input .= '<img id="jcrop4" style="background-color:transparent"/>';
	...
	public function sk_formCor($nomeLabel = '', $nameInput = '', $maxlength = '255', $required = false, $descripton = '', $value = '', $readOnly = '') {
		...
		$input .= '<input type="color"  style="width:'.$maxlength.'px;'.($readOnly ? 'background-color:#E8E8E8;' : '').'" name="' . $nameInput . '" id="' . $nameInput . '" maxlength="' . $maxlength . '" class="' . $nameInput .' '. $required . ' ' . $tooltip . '" title="' . $textoDescription . '" value="' . $value . '" '. $readOnly .' />';
	...
	public function sk_formListar($nome = '', $arrayTableNome, $arrayDadosTable, $campos, $ctrl = '', $permissaopublicar = 0, $permissaoalterar = 0, $permissaoexcluir = 0, $aviso = '', $acaoOrdenar = '',$ctrlRetorno = '',$titulo = '') {
		$formulario = "";
		if ($acaoOrdenar) {
			$formulario .= '<script>';
			$formulario .= '$(function(){';
			...
			if ($permissaopublicar === 1) {
				...
				$formulario .= '</td>';
                        ...
                        if ($permissaoexcluir === 1) {
                            $formulario .= '<td class="actBtns">';
                            if ($permissaoexcluir === 1) {
                                    $formulario .= '<a href="javascript:;" title="Excluir" onclick="confirmDelGeral(\'index.php?acao=deletar&ctrl=' . $ctrl . '&id=' . $arrayDadosTable [$i]->id . '\','. ($ctrlRetorno ? $ctrlRetorno :'\'index.php?acao=listar&ctrl=' . $ctrl . '\'' ). ');" class="tipS">';
                                    $formulario .= '<img src="images/icons/control/16/clear.png" alt="" />';
                                    $formulario .= '</a>';
                            }
                            $formulario .= '</td>';
...
';
	...
	function sk_formHoras($nomeLabel = '', $nameInput = '', $required = false, $descripton = '', $value = '') {
		if ($required == true) {
			$required = 'validate[required]';
			$addAsteristico = '<span class="req">*</span>';
		}
		...
		$input .= '<label>' . $addAsteristico . " " . $nomeLabel . '</label>';
		$input .= '<div class="formRight">';
		$input .= '<div class="horas">';
		$input .= '<input type="text" name="' . $nameInput . '" id="' . $nameInput . '" class="' . $required . ' ' . $tooltip . ' maskTime" title="' . $textoDescription . '" value="' . $value . '" />';
		$input .= '</div>';
		$input .= '</div><div class="clear"></div>';
		$input .= '</div>';
