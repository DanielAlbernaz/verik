...
================================================== */
	...
	$(".maskPhoneExt").mask("(99) 999-9999? x99999");
  ...
  window.onload = function() {
		...
		if (document.getElementById("primeiro_texto") != null) {



            CKEDITOR.replace('primeiro_texto',
		...
		if (document.getElementById("segundo_texto") != null) {



            CKEDITOR.replace('segundo_texto',
		...
		if (document.getElementById("texto_apresentacao_sub") != null) {



            CKEDITOR.replace('texto_apresentacao_sub',
		...
		if (document.getElementById("missao") != null) {
		...
		if (document.getElementById("visao") != null) {
		...
		if (document.getElementById("formacoes") != null) {



            CKEDITOR.replace('formacoes',
...
function searchSeguimento(){
    var id = document.getElementById("idSeguimento");
    var itemSelecionado = id.options[id.selectedIndex].value;
    var url;
    
    url = 'index.php?acao=listar&ctrl=ususario_sig';
    if(itemSelecionado){
        url+='&idCargo='+itemSelecionado;
    }
    
    window.location = url;
}          

function searchVagasEmpregoCargo(){
    var id = document.getElementById("id_seguimento");
    var itemSelecionado = id.options[id.selectedIndex].value;
    var url;
    
    url = 'index.php?acao=listar&ctrl=treinamento';
    if(itemSelecionado){
        url+='&idSeguimento='+itemSelecionado;
    }
...
function searchFormulario(){
    ...
    url = 'index.php?acao=listar&ctrl=forms_landing';
    if(itemSelecionado){
        url+='&nomeFormulario='+itemSelecionado;
    }
...
function searchProdutos(){
	var id = document.getElementById("produtos");
	var itemSelecionado = id.options[id.selectedIndex].value;
	
	var url;  

    url = 'index.php?acao=listar&ctrl=produtos';
    if(itemSelecionado){
        url+='&produto='+itemSelecionado;
    }
...
function searchLandingPage(){
    var id = document.getElementById("landing_page");
    var itemSelecionado = id.options[id.selectedIndex].value;
    var url;
    
    url = 'index.php?acao=listar&ctrl=funcionamento';
    if(itemSelecionado){
        url+='&idLandingPage='+itemSelecionado;
    }
...
function searchEspecialidades(){
    var id = document.getElementById("categoria_especialidade");
    var itemSelecionado = id.options[id.selectedIndex].value;
    var url;
    
    url = 'index.php?acao=listar&ctrl=especialidades';
    if(itemSelecionado){
        url+='&idCategoriaEspecialidade='+itemSelecionado;
    }
...
function searchMedico(){
    var id = document.getElementById("id_medico");
    var itemSelecionado = id.options[id.selectedIndex].value;
    var url;
    
    url = 'index.php?acao=listar&ctrl=avaliacoes';
    if(itemSelecionado){
        url+='&idMedico='+itemSelecionado;
    }
...
function carregarListaEmailTreinamento(idTreinamentoLive) {
	const url = 'index.php?acao=listar&ctrl=lista_inscritos&id_treinamento_live=' + idTreinamentoLive;
	window.location = url;
}



function confirmVisualizarInscricao(url, urlRetorno) {
    $.ajax({
        url: url,
        dataType: 'json',
        type: 'POST',
        ...
        success: function (obj) {
            if (obj.situacao == "sucess") {
                ...
                setTimeout(function () {
                    parent.window.location.href = urlRetorno
                }, 800);
            } else if (obj.situacao == "error") {
                showNotification({
                    message: obj.msg,
...
function submitCsv(){    
    ...
    //Faz o submit do formulário
       ...
       //Atualiza a página para exibir as alterações caso haja algum checkbox marcado
       if(cont > 0){
           setTimeout(function () {
               parent.window.location.href = 'index.php?acao=exportar&ctrl=forms_landing'
           }, 1000);         
       }    
}

function searchTreinamento(){
    var id = document.getElementById("categoria");
    var itemSelecionado = id.options[id.selectedIndex].value;
    var url;
    
    url = 'index.php?acao=listar&ctrl=treinamento_gravado';
    if(itemSelecionado){
        url+='&idCategoria='+itemSelecionado;
    }
    
    window.location = url;
}

function carregarListaEmailTreinamentoPresencial(idTreinamentoLive) {
	const url = 'index.php?acao=listar&ctrl=lista_inscritos_presencial&id_treinamento_presencial=' + idTreinamentoLive;
	window.location = url;
}

function carregarListaEmailTreinamentoAovivo(idTreinamentoLive) {
	const url = 'index.php?acao=listar&ctrl=lista_inscritos_aovivo&id_treinamento_aovivo=' + idTreinamentoLive;
	window.location = url;
}